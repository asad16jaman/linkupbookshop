...
@section('content')
  ...
  <div class="container-fluid bg-breadcrumb">
    ...
    <h1 class="text-white  mb-4 wow fadeInDown" data-wow-delay="0.1s"
      style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInDown;">Best Sell</h1>
    <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s"
      ...
      <li class="breadcrumb-item active text-primary">BestSell</li>
    </ol>
    </div>
  </div>

  @include('user.home.books', ['books' => $bestsell, 'pageName' => 'bestsell'])
